...
local function set_wallpaper(s)
    -- Dir Path
    wp_path = "/home/kitten/.config/awesome/Wallpapers/JPG/"
    -- JPG File
    wp_files = { "_DSC6482.jpg", "_DSC6845.jpg", "_DSC6960.jpg", "_DSC7217.jpg", "_MG_4748.jpg", "_MG_4749.jpg", "_MG_4765.jpg"}
    ...
    if beautiful.wallpaper then
        ...
        gears.wallpaper.centered(wp_path .. wp_files[wp_index], s, false)
    end
end
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Shift" }, "c", function () mymainmenu:show() end, {description = "show main menu", group = "awesome"}),
    -- Layout manipulation
    ...
    awful.key({ modkey, }, "space", function () awful.client.focus.history.previous() if client.focus then client.focus:raise() end end, {description = "go back", group = "client"}),
    -- Standard program
    ...
    -- Menubar With Rofi
    awful.key({ modkey }, "p", function() awful.spawn("rofi -show run") end, {description = "show the menubar", group = "launcher"})
)
